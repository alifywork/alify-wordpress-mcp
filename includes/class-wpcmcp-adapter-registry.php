...
class WPCMCP_Adapter_Registry {
    ...
    public static function adapters() {
        ...
        $adapters = array(
            ...
            'wpforms' => array(
                ...
                'match' => array( 'wpforms-lite/wpforms.php', 'wpforms/wpforms.php', 'wpforms' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'forms', 'notifications', 'confirmations', 'settings' ),
            ),
            'fluent-forms' => array(
                'name' => 'Fluent Forms',
                'type' => 'forms',
                'mode' => 'operator_profile',
                'match' => array( 'fluentform/fluentform.php', 'fluent-forms', 'fluentform' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'forms', 'notifications', 'entries', 'settings' ),
            ),
            'gravity-forms' => array(
                'name' => 'Gravity Forms',
                'type' => 'forms',
                'mode' => 'operator_profile',
                'match' => array( 'gravityforms/gravityforms.php', 'gravityforms', 'gravity-forms' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'forms', 'notifications', 'confirmations', 'entries' ),
            ),
            'forminator' => array(
                'name' => 'Forminator',
                'type' => 'forms',
                'mode' => 'operator_profile',
                'match' => array( 'forminator/forminator.php', 'forminator' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'forms', 'polls', 'quizzes', 'settings' ),
            ),
            'ninja-forms' => array(
                'name' => 'Ninja Forms',
                'type' => 'forms',
                'mode' => 'operator_profile',
                'match' => array( 'ninja-forms/ninja-forms.php', 'ninja-forms' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'forms', 'fields', 'actions', 'settings' ),
            ),
            'rank-math' => array(
                'name' => 'Rank Math SEO',
                'type' => 'seo',
                'mode' => 'operator_profile',
                'match' => array( 'seo-by-rank-math/rank-math.php', 'seo-by-rank-math', 'rank-math' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'seo_meta', 'schema', 'sitemaps', 'settings', 'redirects' ),
            ),
            'yoast' => array(
                'name' => 'Yoast SEO',
                'type' => 'seo',
                'mode' => 'operator_profile',
                'match' => array( 'wordpress-seo/wp-seo.php', 'wordpress-seo', 'yoast' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'seo_meta', 'schema', 'sitemaps', 'settings' ),
            ),
            'seopress' => array(
                'name' => 'SEOPress',
                'type' => 'seo',
                'mode' => 'operator_profile',
                'match' => array( 'wp-seopress/seopress.php', 'wp-seopress', 'seopress' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'seo_meta', 'schema', 'sitemaps', 'settings' ),
            ),
            'wp-mail-smtp' => array(
                ...
                'type' => 'smtp',
                'mode' => 'operator_profile',
                'match' => array( 'wp-mail-smtp/wp_mail_smtp.php', 'wp-mail-smtp' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.secret_vault_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'mailer_settings', 'sender_settings', 'email_test', 'logs' ),
            ),
            'fluent-smtp' => array(
                'name' => 'FluentSMTP',
                'type' => 'smtp',
                'mode' => 'operator_profile',
                'match' => array( 'fluent-smtp/fluent-smtp.php', 'fluent-smtp' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.secret_vault_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'mailer_settings', 'sender_settings', 'email_test', 'logs' ),
            ),
            'learndash' => array(
                ...
                'type' => 'lms',
                'mode' => 'operator_profile',
                'match' => array( 'sfwd-lms/sfwd_lms.php', 'sfwd-lms', 'learndash' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'courses', 'lessons', 'topics', 'quizzes', 'users' ),
            ),
            'tutor-lms' => array(
                'name' => 'Tutor LMS',
                'type' => 'lms',
                'mode' => 'operator_profile',
                'match' => array( 'tutor/tutor.php', 'tutor-lms', 'tutor' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'courses', 'lessons', 'quizzes', 'enrollments', 'settings' ),
            ),
            'memberpress' => array(
                'name' => 'MemberPress',
                'type' => 'membership',
                'mode' => 'operator_profile',
                'match' => array( 'memberpress/memberpress.php', 'memberpress' ),
                'available' => static function () { return true; },
                'tool_prefixes' => array( 'wordpress.plugin_operator_', 'wordpress.adapter_manifest_' ),
                'capabilities' => array( 'memberships', 'rules', 'subscriptions', 'transactions', 'settings' ),
            ),
            'acf' => array(
    ...
    private static function adapter_records() {
        ...
        foreach ( self::adapters() as $id => $adapter ) {
            $items[] = array(
                ...
                'mode' => isset( $adapter['mode'] ) ? $adapter['mode'] : 'native',
    ...
    private static function plan_tool( array $args ) {
        ...
        if ( ! empty( $detected['dedicated_adapter'] ) && ! empty( $detected['dedicated_adapter']['available'] ) ) {
            $steps[] = array(
                'action' => ( ! empty( $detected['dedicated_adapter']['mode'] ) && 'operator_profile' === $detected['dedicated_adapter']['mode'] ) ? 'use_operator_profile' : 'use_dedicated_adapter',
